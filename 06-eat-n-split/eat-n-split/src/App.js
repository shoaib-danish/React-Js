...
function App() {
  ...
  function handleShowAddFeiend() {
    setShowAddFriend((show) => !show);
  }

  function handleAddFreiend(friend) {
  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        />
        {showAddFriend && <FormAddFriend onAddFriend={handleAddFreiend} />}
        <Button onClick={handleShowAddFeiend}>
